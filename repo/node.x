...
${bold}${NODENAME} is no longer actively supported!${normal}
   ...
   * ${green}https://deb.nodesource.com/setup_10.x â€” Node.js v10 LTS \"Dubnium\"${normal} (recommended)
   * ${green}https://deb.nodesource.com/setup_12.x â€” Node.js v12 LTS \"Erbium\"${normal}
